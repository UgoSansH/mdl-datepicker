(function(window) {
    ...
    epepite.DatePicker.TEMPLATES.default =
        ...
        + '<button type="button" name="mdl-calendar-year-prev" class="%YEAR_PREV_CLASS% %VISIBLE_CLASS% mdl-calendar__year--button left mdl-calendar__button">'
        + '<i class="icon material-icons">keyboard_arrow_left</i></button><p class="%YEAR_CLASS%">2016</p>'
        + '<button type="button" name="mdl-calendar-year-next" class="%YEAR_NEXT_CLASS% %VISIBLE_CLASS% mdl-calendar__year--button right mdl-calendar__button">'
        ...
        + '<button type="button" name="mdl-calendar__month--prev" class="%MONTH_PREV_CLASS% %VISIBLE_CLASS% mdl-calendar__button"><i class="icon material-icons">keyboard_arrow_left</i></button>'
        + '<p class="mdl-calendar__body-month-title"><span class="%MONTH_CLASS%">Mars</span> <span class="%YEAR_CLASS%">2016</span></p>'
        + '<button type="button" name="mdl-calenda__month--next" class="%MONTH_NEXT_CLASS% %VISIBLE_CLASS% mdl-calendar__button"><i class="icon material-icons">keyboard_arrow_right</i></button>'
